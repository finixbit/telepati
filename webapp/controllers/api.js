...
router.post('/profile', setUserProfile);
router.get('/profile', getUserProfile);
router.post('/ping', userProfilePing);
router.get('/users', getUsers);
router.get('/keys', getProfileKeys);
router.post('/keys', setProfileKeys);
router.post('/messages', getUserMessages);
router.post('/messages/send', sendUserMessage);
